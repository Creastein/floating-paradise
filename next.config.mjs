...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://www.googletagmanager.com https://www.google-analytics.com https://tripla.jp https://*.tripla.ai;
...
// Collapse into a single line (headers must not contain newlines)
