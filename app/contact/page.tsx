...
import { MapPin, WhatsappLogo, EnvelopeSimple, InstagramLogo } from '@phosphor-icons/react/dist/ssr'

export const metadata = {
  title: 'Contact Us | Floating Paradise',
  description: 'Get in touch with Floating Paradise Karimunjawa. Find our location, WhatsApp numbers, email, and Instagram.',
}
            ...
            <div className="space-y-6 md:sticky md:top-32">
              ...
              <FadeIn direction="right" distance={40} delay={0.1}>
                <p className="text-lg text-foreground/80 font-light leading-relaxed">
                  Floating Paradise is a small and personal place. Reach out — we&apos;re happy to help with anything before, during, or after your stay.
                </p>
              </FadeIn>
            </div>
            ...
            <div className="space-y-3">
              ...
              <FadeIn direction="left" distance={40} delay={0.2}>
                <div className="bg-[#F5EFE4] py-4 px-5 rounded-2xl flex items-start gap-6 group hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="space-y-3 w-full">
                    <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">WhatsApp</h3>
              ...
              <FadeIn direction="left" distance={40} delay={0.3}>
                <div className="bg-[#F5EFE4] py-4 px-5 rounded-2xl flex items-start gap-6 group hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Email</h3>
              ...
              <FadeIn direction="left" distance={40} delay={0.4}>
                <div className="bg-[#F5EFE4] py-4 px-5 rounded-2xl flex items-start gap-6 group hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Instagram</h3>
                    <div className="text-foreground text-lg leading-relaxed pt-1">
                      <a 
